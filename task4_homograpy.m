...
[features1, eigen1] = eigen_vectors(image1, 0.2622);
[row1,col1] = find(features1);
feat_vec1 = [row1 col1];
[features2, eigen2] = eigen_vectors(image2, 0.1725);
...
%%
% get homography matrix, number of inlier using homography RANSAC
[trans_mat_iter, match_count_iter, max_inlier, trans_mat, feat_index] = homography_ransac(row1, col1, row2, col2, 45);
